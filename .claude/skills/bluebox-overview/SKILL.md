...
- **Instrument a service** — Bluebox detects your language and deployment model, then sets up OpenTelemetry so traces, metrics, and logs flow to your Dynatrace tenant.
